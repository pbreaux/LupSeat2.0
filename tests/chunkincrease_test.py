...
class ChunkIncreaseMethods(unittest.TestCase):
    def test_distribute_empty(self):
        ...
        _, chk_size_l = ChunkIncrease.get_empty_seats_inds(sg, 5)
        empty_inds = ChunkIncrease.distribute_empty(sg, 5, chk_size_l)
        self.assertTrue(('a', 7) in empty_inds)

        sg = SeatGroups(('a', 4), ('a', 16))
        _, chk_size_l = ChunkIncrease.get_empty_seats_inds(sg, 3)
        empty_inds = ChunkIncrease.distribute_empty(sg, 3, chk_size_l)
    ...
    def test_get_empty_seats_inds(self):
        sg = SeatGroups(('a', 4), ('a', 10))
        empty_inds, chk_size_l = ChunkIncrease.get_empty_seats_inds(sg, 5)
        self.assertTrue(('a', 9) in empty_inds)
        self.assertEqual(chk_size_l, [5, 1])

        sg = SeatGroups(('a', 4), ('a', 10))
        empty_inds, chk_size_l = ChunkIncrease.get_empty_seats_inds(sg, 2)
        self.assertTrue(('a', 6) in empty_inds)
        self.assertTrue(('a', 9) in empty_inds)
        ...
        empty_inds, chk_size_l = ChunkIncrease.get_empty_seats_inds(sg, 3)
        self.assertTrue(('a', 7) in empty_inds)
